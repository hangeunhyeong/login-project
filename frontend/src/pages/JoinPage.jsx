...
function JoinPage(){
    ...
    const [isUsernameValid, setIsUsernameValid] = useState(null);   // null : 검사전, true : 사용가능, false : 중복
    ...
    useEffect(() => {
    ...
    }, [username]); // username이 바뀔때마다 함수(첫번째인자)를 실행해라
     ...
     const handleSignUp = async (e) => {
        ...
        if(
            ...
            setError("입력값을 다시 확인해주세요. 모든항목은 필수이며, ID/비밀번호는 최소 4자입니다");
            return;
        }
